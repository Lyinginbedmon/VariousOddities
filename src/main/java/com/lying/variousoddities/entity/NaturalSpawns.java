...
//FIXME Reimplement natural spawn rules
...
public class NaturalSpawns
{
	...
	static
	{
//		addSpawns(VOEntities.CRAB.get(), true,
//				"{ocean,10,4}",
...
//		addSpawns(VOEntities.CRAB_GIANT.get(), true,
//				"{ocean,10,1}",
...
//		addSpawns(VOEntities.GOBLIN.get(), true,
...
//		addSpawns(VOEntities.KOBOLD.get(), true,
...
//		addSpawns(VOEntities.RAT.get(), true,
...
//		addSpawns(VOEntities.RAT_GIANT.get(), true,
...
//		addSpawns(VOEntities.SCORPION.get(), true,
...
//		addSpawns(VOEntities.SCORPION_GIANT.get(), true,
//				"{hot:dry:sandy,60,2}",
//				"{dry:mesa,60,2}",
//				"{hot:wasteland,60,2}",
